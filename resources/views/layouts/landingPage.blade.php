...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>PT. Magitha Citra Nusantara (MCN)</title>
    <meta name="title" content="PT. Magitha Citra Nusantara (MCN)">
    ...
    <meta property="og:description"
        content="A company that focuses on providing telecommunication materials and services based on fiber optic technology. Currently, PT. MCN is quite taken into account in Indonesian telecommunications. With the motto &quot;The Power of Change&quot; spurred PT. MCN to always adapt to various changes and technological advances. The quality of production and the trust of partners is a priority for us.">
    <meta property="og:image" content="backend/image/setting/popup-pt-magitha-citra-nusantara-mcn.jpg">
    ...
    <meta property="twitter:description"
        content="A company that focuses on providing telecommunication materials and services based on fiber optic technology. Currently, PT. MCN is quite taken into account in Indonesian telecommunications. With the motto &quot;The Power of Change&quot; spurred PT. MCN to always adapt to various changes and technological advances. The quality of production and the trust of partners is a priority for us.">
    <meta property="twitter:image" content="backend/image/setting/popup-pt-magitha-citra-nusantara-mcn.jpg">
    ...
    <script data-turbolinks-eval="false">
        ...
        window.livewire_token = 'XbwPyto5kY7435Dz1FMePPlhVqk2zvZAf0A8R19J';
...
<body>
                ...
                <div class="row">
                    <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
                        <div class="footer_widget footer_info mb-50 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="footer_widget_logo">
                                <h4 class="footer_title_text">Contact US <span class="footer_sub_text">If you need
                                        more help.</span></h4>
                            </div>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
                        <div class="footer_widget footer_links w_50 mb-50 pl-40 fix wow fadeInUp"
                            ...
                            <div class="footer_widget_title">
                                <h4 class="footer_title_text">Get In Touch <span class="footer_sub_text">Easy to catch
                                        us here</span></h4>
                            </div>
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="footer_widget mb-50 pl-10 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="footer_widget_title">
                                <h4 class="footer_title_text">Maps <span class="footer_sub_text">Get Direct to
                                        Location</span></h4>
                            </div>
                ...
                <div class="row">
                    <div class="col-xxl-5 col-sm-6">
                        <p class="copyright_text mb-30 text-center text-sm-start wow fadeInLeft"
                            data-wow-delay="0.3s">Copyright by <a href="#">PT. Magitha Citra Nusantara</a> -
                            2022
                        </p>
                    </div>
    ...
    <script type="text/javascript">
        ...
        L.circle([-6.9512526, 107.5860536], 250, {
            ...
            fillColor: '#2ecc71',
            fillOpacity: 0.2
        }).addTo(map).bindPopup("Lokasi PT. Magitha Citra Nusantara");
