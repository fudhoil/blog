                            ...
                            <div class="card-spacer mt-n25">
                                ...
                                <div class="row m-0">
                                    <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                        ...
                                        <a href="#" class="text-warning font-weight-bold font-size-h6">{{ $count_product }} Data
                                            Produk</a>
                                    </div>
                                ...
                                <div class="row m-0">
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                        ...
                                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">{{ $count_news }} Data News</a>
                                    </div>
                                    <div class="col bg-light-success px-6 py-8 rounded-xl">
                                        ...
                                        <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">{{ $count_client }} Data Client</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                            </div>
